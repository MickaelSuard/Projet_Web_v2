...
export function Navbar({ user, searchQuery, onSearchChange }: Readonly<NavbarProps>) {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-slate-200 bg-white/80 shadow-sm backdrop-blur-md">
      <div className="mx-auto flex h-16 max-w-7xl items-center gap-4 px-4 sm:px-6 lg:px-8">
        <a href="/" className="shrink-0 text-xl font-black tracking-tight text-slate-900 transition-colors hover:text-indigo-600" style={{ fontFamily: "'Georgia', serif" }}>Bloutub</a>
